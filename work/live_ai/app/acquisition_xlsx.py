...
def export_acquisitions(month):
    ...
    body=wb.add_format({"font_color":"#172B3F","bg_color":"#FFFFFF","border":1,"border_color":"#D8E1EA","valign":"vcenter"})
    money=wb.add_format({"font_color":"#172B3F","bg_color":"#FFFFFF","num_format":'#,##0 "TL"',"border":1,"border_color":"#D8E1EA","valign":"vcenter"})
