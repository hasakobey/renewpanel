...
(()=>{function init(){window.__renewProbe=window.__renewProbe||[];window.__renewProbe.push({script:'renew-stitch-details.js',readyState:document.readyState,rcWorkspace:!!document.querySelector('.rc-workspace'),rcHistory:!!document.getElementById('rcHistory'),rcCompareBody:!!document.getElementById('rcCompareBody'),rcMiniActions:!!document.querySelector('.rc-mini-actions'),t:Math.round(performance.now())});
